...
<%
		...
		String mid = request.getParameter("mid"); // 제목
		// DB에 삽입할 준비 완료
		...
		try {
			...
			if(rs.next()){
				...
				response.sendRedirect("memberModify.jsp"); // 강제이동
			}
		...
		request.setAttribute("memberDto", memberDto); // 조회된 회원정보가 들어 있는 memberDto를 request 객체
	%>
	<h2>회원 정보 수정</h2>
	<hr>
